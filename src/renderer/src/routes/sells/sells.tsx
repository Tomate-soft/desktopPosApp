...
export default function Sells() {
  ...
  return (
    <div className={styles.container}>
      ...
      {closedBillBoard.isOpen && closedBillBoard.modalName === CLOSED_BILLBOARD_MODAL ? (
        <ClosedBillBoard isOpen={closedBillBoard.isOpen} onClose={closedBillBoard.closeModal}>
          Cuentas finalizadas
        </ClosedBillBoard>
      ) : null}
