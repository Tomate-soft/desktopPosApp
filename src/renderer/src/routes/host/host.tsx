...
import backIcon from '@renderer/assets/icon/backIcon.svg'
import homeIcon from '@renderer/assets/icon/homeIcon.svg'
...
import { CONFIRM_CHANGES, EXCEPTION_MESSAGES_CASHIER_SESSION_MODAL } from '../../lib/modals.lib'
...
import { ADMIN } from '@renderer/components/tools/confirmPassword/lib'
import JoinTables from '@renderer/components/joinTables/joinTables'
import { UseTableStore } from '@renderer/store/tables.store'
...
export default function Host() {
  ...
  return (
    <div className={styles.container}>
      ...
      {joinTablesModal.isOpen && joinTablesModal.modalName === 'JOIN_TABLES' && allowEdit ? (
        <JoinTables isOpen={joinTablesModal.isOpen} onClose={joinTablesModal.closeModal}>
          Join tables
        </JoinTables>
      ) : null}
