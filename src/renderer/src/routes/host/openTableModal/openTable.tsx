import { Table } from '@renderer/routes/tablesControl/type'
import styles from './openTable.module.css'
import CloseButton from '@renderer/components/buttons/CloseButton/closeButton'
import incrementIcon from '@renderer/assets/icon/incrementxl.svg'
import decrementIcon from '@renderer/assets/icon/decrementIcon.svg'
