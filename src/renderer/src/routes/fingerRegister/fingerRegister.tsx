      ...
      <main className={styles.mainSection}>
        ...
        <section className={styles.employeesContainer}>
          ...
          <div>
            ...
            <input placeholder="Dave mustaine...    James hetfield...    etc..." type="search" />
          </div>
          <div>
            ...
            {usersArray?.map((element: any, index: any) => (
              ...
              >
                <div className={styles.avatar} style={{ background: element.color }}>
                ...
                <div>
                  <img src={element.samples.length ? enableIcon : pendingIcon} alt="icon-status" />
