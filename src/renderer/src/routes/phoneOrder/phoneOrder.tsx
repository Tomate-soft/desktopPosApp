...
import ConfirmPayment from '@renderer/components/modals/confirmPayments/confirmPayments'
import { GENERIC_KEYBOARD_ACTIVE } from '@renderer/components/genericKeyboard/config'
import { GenericKeyboard } from '@renderer/components/genericKeyboard/genericKeyboard'
import { ENABLE_STATUS } from '@renderer/lib/tables.status.lib'
...
export default function PhoneOrders() {
  ...
  return (
    <div className={styles.container}>
      ...
      {moreActionMenu.isOpen && moreActionMenu.modalName === MORE_ACTIONS_MENU ? (
        <MoreActionsMenu
          type={TO_GO_ORDER}
          item={currentOrder}
      ...
      {confirmPayment.isOpen && confirmPayment.modalName === CONFIRM_PAYMENT_MODAL ? (
        <ConfirmPayment
          setIsLoading={setIsloading}
          revolve={revolve}
          isLoading={isLoading}
