  ...
  return (
    <>
      ...
      <div className={styles.container}>
        ...
        {exceptionMessage.isOpen && exceptionMessage.modalName === EXCEPTION_MESSAGES_MODAL ? (
          <ExceptionMessages isOpen={exceptionMessage.isOpen} onClose={exceptionMessage.closeModal}>
