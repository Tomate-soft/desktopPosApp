...
import { useCashierSession } from '@renderer/store/cashierSession.store'
...
export default function Cashier() {
  ...
  const pauseResumeSession = useCashierSession((state) => state.pauseResumeSession)
  ...
  return (
    <div className={styles.container}>
      ...
      <main className={styles.mainSection}>
        ...
        {paymentInterface.isOpen && paymentInterface.modalName === PAYMENT_INTERFACE_MODAL ? (
          <PaymentInterface
      ...
      <footer className={styles.footer}>
        ...
        {filterSession && filterSession.length > 0 && filterSession[0]?.enable ? (
          <button
