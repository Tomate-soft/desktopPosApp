...
import { CONFIRM_PAYMENT_MODAL } from '@renderer/lib/modals.lib'
        ...
        <div>
          ...
          <div>
                ...
                <div className={styles.categoriesSelect}>
                  ...
                  >
                    <div className={styles.selectTrigger}>
                      ...
                      <span>
                        {status ? (status === 'enabled' ? 'Activo' : 'Inactivo') : 'Todos'}
                      </span>
                    </div>
            ...
            <div>
              ...
              {confirmChanges.isOpen && confirmChanges.modalName === CONFIRM_PAYMENT_MODAL ? (
                <ConfirmChanges
