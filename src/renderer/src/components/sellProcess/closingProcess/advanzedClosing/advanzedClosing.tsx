...
import { useAuthStore } from '@renderer/shared'
import { useClosureOfOperationsStore } from '@renderer/store/closureOfOperations/closureOfOperations.store'
...
export default function AdvanzedClosing({ onClose, sessionActive }: Props) {
  ...
  const closeCashierSession = useClosureOfOperationsStore((state) => state.closeCashierSession)
  ...
  const sendData = {
    ...
    finallyMount: (efectivoTotal + parseFloat(balanceTargets)).toFixed(2).toString()
  }
          ...
          <div className={styles.secondaryContainer}>
            ...
            <div className={styles.totals}>
              ...
              <div>
                ...
                <h3>{`$${!isNaN(parseFloat(balanceTargets)) ? balanceTargets : 0} MXN`}</h3>
              </div>
            </div>
          </div>
          <div>
            ...
            <div>
              ...
              <h3>{`$${sendData.finallyMount ? sendData.finallyMount : 0} MXN`}</h3>
            </div>
          </div>
        </div>
      </div>
